  ...
  return (
    <section className="hero" id="start" onMouseMove={handleMouseMove}>
      ...
      <motion.div className="heroCopy" initial={{ opacity: 0, y: 44, filter: "blur(14px)" }} animate={{ opacity: 1, y: 0, filter: "blur(0px)" }} transition={{ duration: 0.9, delay: 1 }}>
        <span className="badge">KARIVO X 2.3 · Interactive Studio</span>
        <h1>Websites, die aus Besuchern Kunden machen.</h1>
        <p>Premium-Websites für lokale Unternehmen — modern, schnell, mobil optimiert und so gestaltet, dass dein erster Eindruck sofort professionell wirkt.</p>
        <div className="actions">
          <a className="btn primary" href="#konfigurator">Website konfigurieren</a>
